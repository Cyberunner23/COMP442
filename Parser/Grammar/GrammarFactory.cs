...
namespace Parser.Grammar
{
    class GrammarFactory
    {
        public static Dictionary<NonTerminal, GrammarRule> CreateGrammar()
        {
            ...
            ClassDecls.RHSSet.Add(new List<RuleBase>() { });
            ...
            FuncDefs.RHSSet.Add(new List<RuleBase>() { });
            ...
            MemberDecls.RHSSet.Add(new List<RuleBase>() { });
            ...
            StatementVarExt.RHSSet.Add(new List<RuleBase>() { });
            ...
            FuncParams.RHSSet.Add(new List<RuleBase>() { });
            ...
            OptionalInherits.RHSSet.Add(new List<RuleBase>() { });
            ...
            FuncCallParamsRests.RHSSet.Add(new List<RuleBase>() { });
            LocalScope.RHSSet.Add(new List<RuleBase>() { Local, VarDecls });
            LocalScope.RHSSet.Add(new List<RuleBase>() { });
            ArrayDims.RHSSet.Add(new List<RuleBase>() { ArraySize, ArrayDims });
            ArrayDims.RHSSet.Add(new List<RuleBase>() { });
            ...
            BoolExprOrNone.RHSSet.Add(new List<RuleBase>() { });
            Statements.RHSSet.Add(new List<RuleBase>() { Statement, Statements });
            Statements.RHSSet.Add(new List<RuleBase>() { });
            ArithExpr.RHSSet.Add(new List<RuleBase>() { Term, RightArithExpr });
            RightArithExpr.RHSSet.Add(new List<RuleBase>() { });
            ...
            FuncParamsRests.RHSSet.Add(new List<RuleBase>() { });
            InheritedClasses.RHSSet.Add(new List<RuleBase>() { Comma, Identifier, InheritedClasses });
            InheritedClasses.RHSSet.Add(new List<RuleBase>() { });
            ...
            VarDecls.RHSSet.Add(new List<RuleBase>() { });
            ...
            FactorVar.RHSSet.Add(new List<RuleBase>() { });
            FactorFuncCall.RHSSet.Add(new List<RuleBase>() { Period, VarFuncCall });
            FactorFuncCall.RHSSet.Add(new List<RuleBase>() { });
            ...
            RightTerm.RHSSet.Add(new List<RuleBase>() { });
            ...
            OptionalInt.RHSSet.Add(new List<RuleBase>() { });
            ...
            FuncCallParams.RHSSet.Add(new List<RuleBase>() { });
            ...
            StatementBlock.RHSSet.Add(new List<RuleBase>() { });
            Indices.RHSSet.Add(new List<RuleBase>() { Index, Indices });
            Indices.RHSSet.Add(new List<RuleBase>() { });
